...
Buffer socks5_format_auth_request(Logger * = Logger::global());
ErrorOr<bool> socks5_parse_auth_response(Buffer &, Logger * = Logger::global());
ErrorOr<Buffer> socks5_format_connect_request(Settings, Logger * = Logger::global());
ErrorOr<bool> socks5_parse_connect_response(Buffer &, Logger * = Logger::global());
