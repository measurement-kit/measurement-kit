...
echo "* Generating include-android.mk"
echo "# Autogenerated by $0 on date $(date)"                      > include-android.mk
echo ""                                                          >> include-android.mk
gen_sources LOCAL_SRC_FILES src/libmeasurement_kit "../../../"   >> include-android.mk
