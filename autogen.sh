...
gen_headers() {
    ...
    # Note: common/version.hpp is autogenerated by ./configure but we need to
    # fake it out now otherwise it would not be included in common.hpp
