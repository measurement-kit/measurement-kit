...
MK_DEFINE_ERR(2006, UnknownError, "")
MK_DEFINE_ERR(2007, TimeoutError, "generic_timeout_error")
MK_DEFINE_ERR(2008, ShutdownError, "")
MK_DEFINE_ERR(2009, CancelError, "")
MK_DEFINE_ERR(2010, NoDataError, "dns_lookup_error")
MK_DEFINE_ERR(2011, InvalidIPv4AddressError, "")
MK_DEFINE_ERR(2012, InvalidIPv6AddressError, "")
MK_DEFINE_ERR(2013, UnsupportedClassError, "")
MK_DEFINE_ERR(2014, InvalidNameForPTRError, "")
MK_DEFINE_ERR(2015, ResolverError, "")
MK_DEFINE_ERR(2016, UnsupportedTypeError, "")
