...
class Response {
  ...
  public:
     ...
     *        [libevent's
     * github](https://github.com/libevent/libevent/blob/master/include/event2/dns.h#L147)
     * for the available status codes).
     * \param type evdns query type (e.g., DNS_IPv4_A -- see
     *        [libevent's
     * github](https://github.com/libevent/libevent/blob/master/include/event2/dns.h#L176)
     ...
     *          AAAA and A queries.
     */
    std::vector<std::string> get_results(void) { return results; }
     ...
     */
    std::string get_reply_authoritative(void) { return "unknown"; /* TODO */ }

    /*!
     * \brief Get the integer status code returned by evdns.
     */
    int get_evdns_status(void) { return code; }

    /*!
     * \brief Map the status code returned by evdns to a OONI failure string.
     */
    std::string get_failure(void) { return map_failure_(code); }

    /*!
     * \brief Get the time to live of the response.
     */
    int get_ttl(void) { return ttl; }
     ...
     */
    double get_rtt(void) { return rtt; }
