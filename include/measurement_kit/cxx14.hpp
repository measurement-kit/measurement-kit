...
class TaskRunner {
  public:
    /// Constructs a TaskRunner. @param suppress Whether to suppress exceptions
    /// in callbacks (true) or to return when they occur (false).
    explicit TaskRunner(bool suppress) : suppress_cb_exceptions_{suppress} {}
  ...
  private:
    std::atomic_bool suppress_cb_exceptions_{true};
};
