...
MK_DEFINE_ERR(MK_ERR_HTTP(12), ParserInvalidEofStateError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(13), ParserHeaderOverflowError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(14), ParserClosedConnectionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(15), ParserInvalidVersionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(16), ParserInvalidStatusError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(17), ParserInvalidMethodError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(18), ParserInvalidUrlError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(19), ParserInvalidHostError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(20), ParserInvalidPortError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(21), ParserInvalidPathError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(22), ParserInvalidQueryStringError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(23), ParserInvalidFragmentError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(24), ParserLfExpectedError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(25), ParserInvalidHeaderTokenError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(26), ParserInvalidContentLengthError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(27), ParserUnexpectedContentLengthError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(28), ParserInvalidChunkSizeError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(29), ParserInvalidConstantError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(30), ParserInvalidInternalStateError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(31), ParserStrictModeAssertionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(32), ParserPausedError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(33), GenericParserError, "")
