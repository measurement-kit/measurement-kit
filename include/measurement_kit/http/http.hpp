...
MK_DEFINE_ERR(MK_ERR_HTTP(13), PausedAfterParsingHeadersError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(14), ParsingBodyInProgressError, "")

MK_DEFINE_ERR(MK_ERR_HTTP(15), ParserInvalidEofStateError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(16), ParserHeaderOverflowError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(17), ParserClosedConnectionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(18), ParserInvalidVersionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(19), ParserInvalidStatusError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(20), ParserInvalidMethodError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(21), ParserInvalidUrlError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(22), ParserInvalidHostError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(23), ParserInvalidPortError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(24), ParserInvalidPathError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(25), ParserInvalidQueryStringError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(26), ParserInvalidFragmentError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(27), ParserLfExpectedError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(28), ParserInvalidHeaderTokenError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(29), ParserInvalidContentLengthError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(30), ParserUnexpectedContentLengthError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(31), ParserInvalidChunkSizeError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(32), ParserInvalidConstantError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(33), ParserInvalidInternalStateError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(34), ParserStrictModeAssertionError, "")
MK_DEFINE_ERR(MK_ERR_HTTP(35), ParserPausedError, "")
