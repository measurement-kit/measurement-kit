...
MK_DEFINE_ERR(MK_ERR_OONI(9), CannotOpenGeoIpCountryDatabaseError, "")
MK_DEFINE_ERR(MK_ERR_OONI(10), CannotOpenGeoIpCityDatabaseError, "")
MK_DEFINE_ERR(MK_ERR_OONI(11), CannotOpenGeoIpAsnDatabaseError, "")
