...
MK_DEFINE_ERR(MK_ERR_OONI(0), CannotReadAnyInputFileError, "cannot_read_any_input_file")
MK_DEFINE_ERR(MK_ERR_OONI(1), MissingRequiredInputFileError, "missing_required_input_file")
MK_DEFINE_ERR(MK_ERR_OONI(2), MissingCollectorBaseUrlError, "missing_collector_base_url")
...
MK_DEFINE_ERR(MK_ERR_OONI(5), InvalidMandatoryValueError, "invalid_mandatory_value")
...
MK_DEFINE_ERR(MK_ERR_OONI(8), GeoipDatabaseOpenError, "cannot_open_geoip_database")
MK_DEFINE_ERR(MK_ERR_OONI(9), GeoipCountryCodeLookupError, "cannot_find_country_code")
MK_DEFINE_ERR(MK_ERR_OONI(10), GeoipCountryNameLookupError, "cannot_find_country_name")
...
MK_DEFINE_ERR(MK_ERR_OONI(13), CannotGetResourcesVersionError, "cannot_get_resources_version")
