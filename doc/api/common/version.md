...
#define MK_VERSION_WITH_GIT_TAG "v0.6.0-beta-6-abcdef"
...
to know MeasurementKit version number. The `MK_VERSION_WITH_GIT_TAG` macro
...
interface. There is also `mk_version_with_git_tag()` that returns the more
