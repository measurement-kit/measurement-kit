...
//
// DEPRECATED - This file will be discontinued soon in favor of a
// solution that directly feeds SWIG with real .hh files.
//
// As such, this file is no longer updated by ./configure and
// will keep mirroring the API that was available the last time
