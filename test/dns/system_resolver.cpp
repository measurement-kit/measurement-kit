...
static int null_getaddrinfo(const char *, const char *, const struct addrinfo *, struct addrinfo **) {
    return 10;
}

TEST_CASE("the system resolver is able to resolve an ipv4 address") {
    loop_with_initial_event([]() {
            system_resolver("IN", "A", "www.neubot.org", [](Error e, Var<Message> message) {
                    REQUIRE(!e);
...
TEST_CASE("the system resolver returns an error with an invalid_site") {
    loop_with_initial_event([]() {
            system_resolver("IN", "A", "invalid_site", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver can handle a getaddrinfo error") {
    loop_with_initial_event([]() {
            system_resolver<null_getaddrinfo>("IN", "A", "www.neubot.org", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver can handle a inet_ntop error") {
    loop_with_initial_event([]() {
            system_resolver<getaddrinfo, null_inet_ntop>("IN", "A", "invalid_site", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver can handle an unsupported class") {
    loop_with_initial_event([]() {
            system_resolver("CS", "A", "neubot.org", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver can handle an unsupported query type") {
    loop_with_initial_event([]() {
            system_resolver("IN", "NS", "neubot.org", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver can handle errors with a CNAME query") {
    loop_with_initial_event([]() {
            system_resolver("IN", "CNAME", "invalid.foo", [](Error e, Var<Message>) {
                    REQUIRE(e);
                    break_loop();
                    }, {}, Reactor::global(), Logger::global());
            });
...
TEST_CASE("the system resolver doesn't resolve the canonical name with A query") {
    loop_with_initial_event([]() {
            system_resolver("IN", "A", "ipv4.google.com", [](Error e, Var<Message> message) {
                    REQUIRE(!e);
                    REQUIRE(message->answers.size() > 0);
...
TEST_CASE("the system resolver is able to resolve the canonical name with CNAME query") {
    loop_with_initial_event([]() {
            system_resolver("IN", "CNAME", "ipv4.google.com", [](Error e, Var<Message> message) {
                    REQUIRE(!e);
                    REQUIRE(message->answers.size() > 0);
